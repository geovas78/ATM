 ...
 * @author GOGO
 */
class CardInserted2 implements ActionListener {
    ...
    private Servises service = new Servises();
    ...
    public CardInserted2() {
        ...
        String prompt = "INSERT YOUR PIN BELOW";
    ...
    public void accessGranted() {
        ...
        //int actualPassword = details.getPIN();
        String actualPassword = DataFromDB.getPIN();
        ...
        if (actualPassword.equals(password)) {
            ...
            topPanel.add(new WrongPinLabel());
            ...
            if (attempts == 3) {
                ...
                //write the block value to the card chip
                writeOnTheCardchip();
    ...
    private void writeOnTheCardchip() {
        ...
        try {
            ...
            String detailsCodedString = URLEncoder.encode(accountNumberSend, "UTF-8");

            URL url = new URL("https://webbank-gvasilski.rhcloud.com/BlockAccessCard");
            ...
            while ((feedback = in.readLine()) != null) {
                String getReturnedInfo = feedback;
            }
            in.close();
        ...
        message = "THE PIN HAS BEEN BLOCKED";
